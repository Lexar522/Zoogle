...
@foreach ($shopHeaderContactItems ?? [] as $item)
    ...
    >
        ...
        @elseif ($item['kind'] === 'email')
            <svg class="site-header__contact-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" focusable="false" aria-hidden="true">
                <path d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z"/>
                <path d="m22 6-10 7L2 6"/>
            </svg>
        @elseif ($item['kind'] === 'instagram')
            <svg class="site-header__contact-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" focusable="false" aria-hidden="true">
        ...
        @elseif ($item['kind'] === 'viber')
            <svg class="site-header__contact-icon" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" focusable="false" aria-hidden="true">
        ...
        @endif
        <span class="site-header__contact-value">{{ e($item['label']) }}</span>
    </a>
@endforeach
